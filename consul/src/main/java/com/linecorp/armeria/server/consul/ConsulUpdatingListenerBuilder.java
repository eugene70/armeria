...
public final class ConsulUpdatingListenerBuilder {
    ...
    @Nullable private String consulUrl;
    @Nullable private Endpoint serviceEndpoint;

    @Nullable private String checkUrl;
    @Nullable private String checkMethod;
    @Nullable private String checkInterval;
     ...
     * e.g.: "10s", "1m"
     */
    public ConsulUpdatingListenerBuilder checkInterval(String checkInterval) {
        this.checkInterval = requireNonNull(checkInterval, "checkInterval");
        return this;
    }
    ...
    public ConsulUpdatingListener build() {
        ...
        final ConsulClient client = builder.build();
